  ...
  hLightbox: function( args ) {
    ...
    */
    function create( e ) {
      ...
      getContent( href ).then( (content) => {
        ...
        if( _args.closable != null && !_args.closable ) {
          _args.className += ' hLightbox--unclosable';
        }
    ...
    */
    function getContent( href ) {
      ...
      if( href == null ) { 
        console.error('Your Lightbox target does not have HREF attribute');
        return false;
      }
    ...
    */
    function addCloseButton( instance ) {
      ...
      element.querySelector('.hLightbox-content').innerHTML += ` <a class="hLightbox-close" href="#close">Close</a> `;
